...
double precision function kinetic(a, n_el, n_nu, r_el, r_nu)
  ...
  integer                       :: i, j
  double precision, external    :: hp_nucleus, psi
  ...
  do i = 1, n_nu
    ...
    local_k = hp_nucleus(a, n_el, r_el, r_nu(i,:)) / total_psi
...
double precision function hp_nucleus(a, n_el, r_el, r_nu)
  ...
  hp_nucleus = dexp(-a * dist)

end function hp_nucleus
...
double precision function psi(a, n_el, n_nu, r_el, r_nu)
  ...
  integer                       :: i
  double precision, external    :: hp_nucleus
  
  psi = 0.d0

  do i = 1, n_nu

    psi = psi + hp_nucleus(a, n_el, r_el, r_nu(i,:))
